 ...
 * created on Apr 29, 2018, 3:25 PM
 * Software: PyCharm
...
class RegisterByQQ(Register):
    ...
    def register(self):
        print('用QQ注册'.center(40, '-'))

    def login(self):
        print('用QQ登录'.center(40, '-'))


class RegisterByWeChat(Register):
    '''微信注册'''

    def register(self):
        print('用WeChat注册'.center(40, '-'))

    def login(self):
        print('用WeChat登录'.center(40, '-'))

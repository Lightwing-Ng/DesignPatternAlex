 ...
 * created on Apr 29, 2018, 2:18 PM
 * Software: PyCharm
...
if __name__ == '__main__':
    HeadStore = BranchStore("朝阳总店")
    branch = BranchStore("海滨分店")
    join_branch_1 = JoinStore("昌平加盟1店")
    join_branch_2 = JoinStore("昌平加盟2店")

    branch.add(join_branch_1)
    branch.add(join_branch_2)

    HeadStore.add(branch)

    HeadStore.pay_by_card()
    print(HeadStore.my_store_list)
